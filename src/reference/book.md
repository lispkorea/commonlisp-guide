...
- [Successful Lisp](https://dept-info.labri.fr/~strandh/Teaching/PFS/Common/David-Lamkins/cover.html) by David Lamkin
  - [한글: 03장. 12개의 레슨으로 배우는 필수 리스프](https://lispkorea.github.io/successful-lisp-kr/ch03/ch03.html)
...
- [Land of Lisp](http://landoflisp.com/) by Conrad Barski
  - 한글판: 만들면서 배우는 리스프 프로그래밍 - 역자)조태훈 : 절판
...
- [The Art of the Metaobject Protocol](http://metamodular.com/CLOS-MOP/) by Gregor Kiczales, Jim des Rivieres and Daniel G. Bobrow
  - CLOS 와는 달리 클래스 정의 방식이나 디스패치 방식을 동적으로 바꿀 수 있음.
...
- [The Common Lisp Condition System - Beyond Exception Handling with Control Flow Mechanisms](https://www.amazon.com/Common-Lisp-Condition-System-Mechanisms/dp/148426133X) by Michał "phoe" Herda
