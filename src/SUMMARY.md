...
- [함수](./basic/function.md)
  - [재귀](./basic/recursion.md)
- [values](./basic/values.md)
- [return](./basic/return.md)
- [람다](./basic/lambda.md)
- [조건문](./basic/condition.md)
- [비교](./basic/comparison.md)
...
- [타입 part2](./advanced/type-part2.md)
- [에러](./advanced/error.md)
- [매크로](./advanced/macro.md)
